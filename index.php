...
<body>
  ...
  width: 100%;">
									<div class="image" style=" width: 100%;">
										<img src="./images<?php echo $row['image'] ?>" alt="" style=" display: block;
  width: 100%;  height: 250px;">
									</div>
									<div class="details" style=" padding: 15px;">
										<div class="information flex" style="width: 100%; ">
											<p style="font-size: 20px; padding-bottom: 10px;"><?php echo $row['name'] ?></p>
											<h4 style="font-size: 20px; padding-bottom: 10px;">₹<?php echo $row['price'] ?></h4>
										</div>
  ...
  align-items: center;">
											...
											<input type="submit" value="order" name="orderfood" style="padding:5px 15px;
